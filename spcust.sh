...
initCustom()
{
    ...
    echo "Init custom..."
    # rm -rf /home/osboxes/cdunix/ndm/secure+/nodes
}
...
invokeCLI()
{
    /home/osboxes/cdunix/ndm/bin/spcli.sh -e 8 -li y << EOF
    ;
    display info
    ;
    ;
    ...
    ;
    sync netmap 
        path=/home/osboxes/cdunix/ndm/cfg/control/netmap.cfg
        name=*
    ;
    ;
    ; -- Import KeyCert
    ;
    Import KeyCert
        File=/home/osboxes/cdunix/ndm/secure+/certificates/keycert
        Passphrase=P@ssw0rd
    ...
    ;
    Import TrustedCert
        File=/home/osboxes/cdunix/ndm/secure+/certificates/cert
        ImportMode=Add
    ;
    ;
    ; -- Update LocalNode
    ...
    Update LocalNode
        ...
        Override=n
        AuthTimeout=120
        KeyCertLabel=control.example.com
        EncryptData=y
        ClientAuth=n
        CipherSuites=All
        SeaEnable=n
